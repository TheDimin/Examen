...
{
    private SafeZoneBehaviour targetSchuilPlaats = null;
    ...
    {
        OnBestSafeZoneChange(SafeZoneManager.Instance.LastBestSafeZone);
        SafeZoneManager.Instance.OnBestSafeZoneFound.AddListener(OnBestSafeZoneChange);
        cam = Camera.main;
    }
    ...
    private void OnBestSafeZoneChange(SafeZoneBehaviour newSafeZone)
    {
        if (newSafeZone == null)
        {
    ...
    {
        base.Dispose();
        SafeZoneManager.Instance.OnBestSafeZoneFound.RemoveListener(OnBestSafeZoneChange);
    }
}
